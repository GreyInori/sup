...
/**
 * Class QrcodeCompanyWhere
 * @package app\qrcode\controller\api
 */
class QrcodeCompanyWhere extends Controller
{
    public $where = array(
        'company_id' => ['company_id','='],
        'company_name' => ['company_name','LIKE','%code%'],
        'company_linkman' => ['company_linkman','LIKE','%code%'],
        'company_code' => ['company_code','LIKE','%code%']
    );
