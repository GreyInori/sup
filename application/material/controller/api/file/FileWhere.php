 ...
 */
class FileWhere extends Controller
{
    private $where = array(
        'company_full_name' => ['sfn.company_full_name','LIKE','code%'],
        'material_name' => ['sfn.material_name','LIKE','code%'],
        'file_number' => ['sfn.file_number','LIKE','code%'],
        'testing_code' => ['sfn.testing_code','LIKE','code%'],
        'is_valid' => ['sfn.is_valid','LIKE','code%'],
    );
